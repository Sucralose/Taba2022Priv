...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h4>אופן הכנה</h4>
    <ul>
     <li>   מעבירים לקערת המיקסר קמח, סוכר, שמן זית ושמרים.
        </li>
     <li>   להפעיל את המיקסר ולהוסיף מים ומלח עד לקבלת בצק רך.
        </li>
     <li>   מתפיחים את הבצק בקערה עטופה במגבת למשך 40 דקות
        </li>
     <li>   מרדדים את הבצק, מורחים מעט רוטב עגביות, ומפזרים את גבינת המוצרלה ביחד עם שאר התוספות.
        </li>
     <li>   אופים בתנור בחום של 220 מעלות צלזיוס למשך 15-18 דקות. 
        </li>
           </ul> 
      <h3>  בתאבון ! </h3>
